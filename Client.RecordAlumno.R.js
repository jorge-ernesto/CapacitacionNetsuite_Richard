...
define(['N'],
    ...
    function (N) {
        ...
        function fieldChanged(scriptContext) {
            ...
            if (scriptContext.fieldId == 'custrecord_ri_alu_first') {

                let nombreValue = recordContext.getValue('custrecord_ri_alu_first');
        ...
        function ejecutarBoton() {
            ...
            newRecord.setValue('custrecord_ri_alu_first', newValue);
